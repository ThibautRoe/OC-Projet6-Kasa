        ...
        <div className="slideshow">
            ...
            {(pictures.length > 1) && (
                <>
                    ...
                    <button className="slideshow__button slideshow__button--prev" onClick={() => setSlideIndex(slideIndex === 1 ? (pictures.length) : (slideIndex - 1))}>
                    ...
                    <button className="slideshow__button slideshow__button--next" onClick={() => setSlideIndex(slideIndex > (pictures.length - 1) ? 1 : (slideIndex + 1))}>
